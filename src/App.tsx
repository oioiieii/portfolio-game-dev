      ...
      <section ref={sectionRef}
        ...
        <div
          ...
          <div
            ...
            <div
                className="flex justify-center md:justify-start w-full md:w-auto shrink-0">

              <div
                  className="flex flex-col md:flex-row w-full md:w-max p-1 bg-neutral-900 border border-neutral-800 rounded-xl shadow-lg">
                ...
                {DOMAINS.map((domain) => {
                  ...
                  return (
                      <button
                          ...
                          className={`cursor-pointer relative z-10 px-5 py-3 md:py-2 text-lg md:text-xl font-bold transition-colors duration-200 rounded-lg flex items-center justify-between md:justify-center gap-3 ${
                              isActive
                                  ? 'text-neutral-900'
                      ...
                      >
                        ...
                        <span className="relative z-20">{domain}</span>
