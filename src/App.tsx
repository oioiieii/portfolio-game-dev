...
const categoryDescriptions: Record<number, string> = {
  0: "<b>Unity Essentials Pathway</b>— это вводный курс, знакомящий с базовыми принципами работы в Unity и основами геймдизайна. Ниже представлен проект, совмещающий в себе все основные этапы обучения — от создания сцены и настройки объектов до реализации простых игровых механик.",
  1: '<b>Unity Creative Core</b> — это курс, посвящённый практическому освоению инструментов Unity, включая работу с материалами и шейдерами, освещением и постобработкой, анимацией, камерой и другими средствами визуализации. Здесь представлены мои работы, созданные в рамках курса: три упражнения по отдельным аспектам и итоговый проект, объединяющий их в одной сцене.',
  2: "<b>Unity Junior Programmer</b> — это курс по основам программирования на C# в Unity, включая работу с объектами, компонентами и базовыми игровыми механиками. Здесь представлены мои проекты, разработанные в рамках курса, демонстрирующие применение этих навыков.",
...
function App() {
  return (
    <div className={" max-sm:text-xl"}>
      ...
      {/* Новая секция с кнопками и проектами */}
